...
<div class="col-12 col-md-12 col-lg-10 col_12" id='pjax'>
	...
	<div class="box box-content" style="border-radius:0 0 20px 20px;">
				...
				echo $commentClass;
				?> comment-box timeline__item">
					<!--  -->

					<div id="<?php $comments->theId(); ?>">
					<div class="comment-box__inner-dt" style="padding:1.25rem 0rem 0.25rem;">
						<div class="comment-box__body">
							<div class="comm-content-dt">
							<h5 class="title title--h5 timeline__title"><?php $comments->author(); ?><span class="badge"><?php echo $group; ?></span></h5>
										<span class="timeline__period"><?php $comments->date('Y-m-d H:i'); ?></span>
										<p class="timeline__description"><?php echo reEmo($comments->content); ?></p>
							</div>
